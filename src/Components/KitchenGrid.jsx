...
const KitchenGrid = () => {
  return (
    <>
      <div className="grid grid-cols-2 sm:grid-cols-3 max-w-7xl mx-auto gap-8 mt-30">
        {images.map((image, index) => (
          ...
          >
            ...
            <p className="mt-2 self-start md:text-lg">{image.title}</p>
          </div>
        ))}
      </div>
      ...
      <div className="w-full mt-20">
        <img src="Images/Living.jpeg" alt="" className="w-full max-w-7xl mx-auto" />
      </div>
      <div className="w-full mt-20">
        <img src="Images/sofas.jpeg" alt="" className="w-full  object-fit" />
      </div>
      <ServiceGrid />

      <div className="w-full mt-20">
        <img src="Images/Daily.webp" alt="" className="w-full  object-fit" />
      </div>
    </>
  );
};
