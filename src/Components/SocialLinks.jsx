...
import { FaInstagram, FaTwitter, FaFacebook, FaMapMarkerAlt } from 'react-icons/fa';

const socialMedia = [
  { id: 1, icon: <FaInstagram size={30} />, link: "#", bgColor: "bg-yellow-100" },
    ...
    <div className="px-25 mt-20">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {socialMedia.map((social) => (
          ...
          >
            {social.icon}
            {social.text && <span className="mt-2 text-lg font-regular">{social.text}</span>}
          </a>
        ))}
      </div>
    </div>
