      ...
      <div className="container mx-auto px-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-16 gap-y-12 justify-between ml-10">
          {footerDataRow1.map((column, index) => (
            <div key={index}>
              <h1 className="font-bold text-3xl text-gray-800 mb-4">{column.title}</h1>
              <ul className="text-gray-600">
                {column.links.map((link, linkIndex) => (
                  <li key={linkIndex} className="mb-3 text-2xl">
                    <a href={link.href} className="hover:underline hover:text-gray-900 transition-colors">
                      {link.label}
                    </a>
                  </li>
                ))}
        ...
        <div className="mt-20 lg:mt-16 ">
          <div className="inline-block">
            <h3 className="font-bold text-3xl text-gray-800 mb-4">{footerDataRow2.title}</h3>
            <ul className="text-gray-600">
